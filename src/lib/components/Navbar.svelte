...
<nav class="flex justify-between items-center p-2 bg-black/80 text-white shadow-md px-8 border-b border-gray-800 backdrop-blur-xl sticky top-2 mx-4 rounded-lg z-50">
